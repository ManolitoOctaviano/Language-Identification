...
import de.danielnaber.languagetool.tagging.mdh.MaguindanaoTagger;

/** 
 * @author Nathaniel Oco
 */
public class Maguindanao extends Language {

  private Tagger tagger;

  @Override
  public Locale getLocale() {
    return new Locale("mdh");
  }
