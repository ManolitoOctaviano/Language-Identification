...
import de.danielnaber.languagetool.tagging.msb.MasbatenyoTagger;

/** 
 * @author Nathaniel Oco
 */
public class Masbatenyo extends Language {

  private Tagger tagger;

  @Override
  public Locale getLocale() {
    return new Locale("msb");
  }
