...
import de.danielnaber.languagetool.tagging.pag.PangasinenseTagger;

/** 
 * @author Nathaniel Oco
 */
public class Pangasinense extends Language {

  private Tagger tagger;

  @Override
  public Locale getLocale() {
    return new Locale("pag");
  }
