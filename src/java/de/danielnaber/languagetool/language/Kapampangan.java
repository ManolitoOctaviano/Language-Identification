...
import de.danielnaber.languagetool.tagging.pam.KapampanganTagger;

/** 
 * @author Nathaniel Oco
 */
public class Kapampangan extends Language {

  private Tagger tagger;

  @Override
  public Locale getLocale() {
    return new Locale("pam");
  }
