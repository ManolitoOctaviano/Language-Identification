...
import de.danielnaber.languagetool.tagging.hil.HiligaynonTagger;

/** 
 * @author Nathaniel Oco
 */
public class Hiligaynon extends Language {

  private Tagger tagger;

  @Override
  public Locale getLocale() {
    return new Locale("hil");
  }
