...
//    buttonCons.anchor = GridBagConstraints.WEST;
  ...
  public void actionPerformed(final ActionEvent e) {
  	...
  	strTemp = "";
  	for(nCounter = 0; nCounter < str.length; nCounter++) {
		try {
    ...
    resultArea.setText(HTML_FONT_START + strTemp + HTML_FONT_END);
  }
  ...
  private Language getCurrentLanguage() {
    if (autoDetectBox.isSelected()) {
      final LanguageIdentifier langIdentifier = new LanguageIdentifier(str[nCounter]);
